<template>
           ...
           <ul class="advers">
                <li v-for="(item,index) in categoryData" :key="index" @click="onItem(index)" :style="{'height': Liheight +'px','line-height':Liheight +'px' }">
...
<script>
    export default {
        ...
        created(){
            this.Liheight = window.innerWidth *0.96 / 2 
        }  
    }
</script>
